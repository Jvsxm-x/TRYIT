 ...
 */
class getUserCoachRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserCoachRepository' shared autowired service.
     *
     * @return \App\Repository\UserCoachRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserCoachRepository.php';

        return $container->privates['App\\Repository\\UserCoachRepository'] = new \App\Repository\UserCoachRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
