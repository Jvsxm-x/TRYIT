...
class getSchedulerRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SchedulerRepository.php';

        return $container->privates['App\\Repository\\SchedulerRepository'] = new \App\Repository\SchedulerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
