 ...
 */
class getImcRepository2Service extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\temp\ImcRepository' shared autowired service.
     *
     * @return \App\Repository\temp\ImcRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'temp'.\DIRECTORY_SEPARATOR.'ImcRepository.php';

        return $container->privates['App\\Repository\\temp\\ImcRepository'] = new \App\Repository\temp\ImcRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
