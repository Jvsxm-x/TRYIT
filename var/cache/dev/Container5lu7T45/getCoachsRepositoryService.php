 ...
 */
class getCoachsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoachsRepository' shared autowired service.
     *
     * @return \App\Repository\CoachsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoachsRepository.php';

        return $container->privates['App\\Repository\\CoachsRepository'] = new \App\Repository\CoachsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
