...
{
    /**
     * Gets the private 'App\Repository\temp\AbonnementRepository' shared autowired service.
     *
     * @return \App\Repository\temp\AbonnementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'temp'.\DIRECTORY_SEPARATOR.'AbonnementRepository.php';

        return $container->privates['App\\Repository\\temp\\AbonnementRepository'] = new \App\Repository\temp\AbonnementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
