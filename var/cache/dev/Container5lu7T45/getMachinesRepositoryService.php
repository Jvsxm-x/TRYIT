 ...
 */
class getMachinesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MachinesRepository' shared autowired service.
     *
     * @return \App\Repository\MachinesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MachinesRepository.php';

        return $container->privates['App\\Repository\\MachinesRepository'] = new \App\Repository\MachinesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
