...
{
    /**
     * Gets the private 'App\Repository\ImcRepository' shared autowired service.
     *
     * @return \App\Repository\ImcRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ImcRepository.php';

        return $container->privates['App\\Repository\\ImcRepository'] = new \App\Repository\ImcRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
