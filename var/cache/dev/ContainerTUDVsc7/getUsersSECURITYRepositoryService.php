 ...
 */
class getUsersSECURITYRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\temp\UsersSECURITYRepository' shared autowired service.
     *
     * @return \App\Repository\temp\UsersSECURITYRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'temp'.\DIRECTORY_SEPARATOR.'UsersSECURITYRepository.php';

        return $container->privates['App\\Repository\\temp\\UsersSECURITYRepository'] = new \App\Repository\temp\UsersSECURITYRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
